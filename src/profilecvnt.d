...
void main(string[] args)
{
    ...
    if (header.FileVersion != 2 && header.FileVersion != 3 && header.FileVersion != 4)
    {
        fprintf(stderr, "Currently this tools only converts from {v2, v3, v4} to v1. {DetectedFileVersion: %d}\n",
            header.FileVersion);
        return ;
    }
